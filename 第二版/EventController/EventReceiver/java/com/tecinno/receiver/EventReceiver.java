 ...
 public class EventReceiver {
    ...
    /*
     * Java 需要调用的注册方法，把listener注册过来。
     * EventListener ： 客户端的监听者listener
     * OverrideInfo ： 客户端需要监听的接口ID，存放在OverrideInfo数组中
     */
    ...
    /*
     * JNI有native事件会回调postEvent方法并把信息传递过来。
     * postEvent通过handler通知Java listener
     * 如果需要传递其他数据，在msg解析。
     */
